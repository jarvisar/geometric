...
(function () {
    ...
    PG.register({
        ...
        params: [
            ...
            { id: 'spacing', label: 'Spacing (mm)', type: 'range', min: 0.6, max: 12, step: 0.1, value: 2.2, random: [1.2, 5] },
            ...
            { id: 'maxLen', label: 'Max length (mm)', type: 'range', min: 10, max: 2000, step: 10, value: 600, random: [120, 1200] },
